...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="fixed z-40 pt-6 md:pt-8 lg:pt-12 w-full">
      ...
      <div className="flex item-center w-full max-w-[1960px] px-4 md:px-10 lg:px-20 mx-auto justify-between flex-wrap">
        ...
        <div className="flex text-[11px] text-center uppercase font-normal">
          ...
          <a href={CTA_LINK} className="transition hover:scale-105 cursor-pointer bg-black text-xs font-normal buttonShape px-4 py-2.5 md:px-[60px] md:py-3 text-secondary uppercase">
            {CTA_TEXT}
          </a>
